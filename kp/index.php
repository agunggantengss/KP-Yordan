...
<body>
                ...
                <a class="navbar-brand" href="#">Yordan Personal Website</a>
                  ...
                  <div class="collapse navbar-collapse" id="navbar-supported-content">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="#0" data-no="2">Portofolio</a>
                        <div class="circle"></div>
                      </li>
                      <li class="nav-item">
      ...
      <div class="page-width-4 page-left">
        <div class="d-flex position-relative tm-border-top tm-border-bottom intro-container">
          ...
          <div class="intro-right" >
            <img src="img/odan.jpg" alt="Image" class="img-fluid intro-img-1" style=" width: 400px;height: 600px;  border-radius: 50%;margin-left:200px;">
          </div>
    ...
    <li data-page-no="2">
          ...
          <li data-page-no="3" class="px-3">
            <div class="position-relative page-width-1 page-right tm-border-top">
              <div class="circle intro-circle-1"></div>
              <div class="circle intro-circle-2"></div>
              <!-- <div class="circle intro-circle-3"></div>
              <div class="circle intro-circle-4"></div> -->
              <div class="tm-bg-dark content-pad" style="width: 100%">
              ...
              <div class="position-relative mx-auto gallery-container">
                  <!-- <div class="circle intro-circle-1"></div>
                  <div class="circle intro-circle-2"></div> -->
                  <div class="mx-auto tm-border-top gallery-slider" style="display: flex; justify-content: space-between;">  
                    <figure class="effect-julia item" >
                    ...
                    <figure class="effect-julia item" >
                      ...
                      <figcaption>
                          <div>
                              <p>Pendidikan SMP Jaya Suti</p>
                          </div>
                          <a href="#">View more</a>
                      </figcaption>
                      <div>
                            <p>Saya bersekolah SD di Jaya Suti dari 2019-2022</p>
                      </div>
                    </figure>
                    <figure class="effect-julia item">
                        ...
                        <div>
                              <p>Saya bersekolah SMK TELKOM dari 2022-sekarang</p>
                        </div>
                    </figure>
                  </div>
                </div>              
    ...
    <?php
      ...
      if ($resultComments) {
        while ($row = mysqli_fetch_assoc($resultComments)) {
          ...
          echo "<p id='message'>" . $row["Message"] . "</p>";
  ...
  <script>
    var sensor = ['kocak', 'jelek', 'apalagi','anjing','sialan','babi'];
